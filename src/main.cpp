...
// FIXME: this code does not set the name and needs to be fixed, it is non critical
...
void setup() {
  ...
  bool board6Init = board6.begin(PCA9635_MODE1_NONE, PCA9635_MODE2_INVERT | PCA9635_MODE2_TOTEMPOLE);
  flashLED(board6Init);
  if (board6Init) {
  ...
  bool board7Init = board7.begin(PCA9635_MODE1_NONE, PCA9635_MODE2_INVERT | PCA9635_MODE2_TOTEMPOLE);
  flashLED(board7Init);
  if (board7Init) {
